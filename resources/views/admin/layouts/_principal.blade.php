...
<body class="hold-transition layout-top-nav" id="body">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white"
            style="background-color: #00569d !important; color: white !important; font-weight: 900">
            <div class="container">
                <a href="{{ route('home') }}" class="navbar-brand">
                    <img width="125px" style="height: auto" src="{{ asset('bicentenario.png') }}" alt="DPA Logo"
                        class="brand-image">
    ...
    <script>
        $(document).ready(function() {
            // Inicializar Summernote en todos los textareas con la clase .summernote
