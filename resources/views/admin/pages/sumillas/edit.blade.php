                    ...
                    <table class="table borde">
                        ...
                        <tr>
                            <td colspan="10" class="borde">
                                <textarea required name="contenido_sumillas" class="summernote" class="form-control" cols="30" rows="10">{{ $sumilla->contenido_sumillas }}</textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="8" class="borde">
                                ...
                                @if ($curso->tipo == 'GENERAL' && !is_null($sumilla->ejes_transversales))
                                    <textarea required name="ejes_transversales" class="form-control summernote" cols="30" rows="3">{{ $sumilla->ejes_transversales }}</textarea>
                                @else
                                    <input type="checkbox" name="respo_social" value="1"
                                        @if ($sumilla->respo_social == 1) checked @endif> Responsabilidad social
                                    universitaria |
                                    <input type="checkbox" name="inves_formativa" value="1"
                                        @if ($sumilla->inves_formativa == 1) checked @endif> Investigación formativa |
                                    <input type="checkbox" name="idi" value="1"
                                        @if ($sumilla->idi == 1) checked @endif> I+D+i (investigación + desarrollo
                                    + innovación) |
                                    <input type="checkbox" name="sostenibilidad" value="1"
                                        @if ($sumilla->sostenibilidad == 1) checked @endif> Sostenibilidad ambiental |
                                    <input type="checkbox" name="etica" value="1"
                                        @if ($sumilla->etica == 1) checked @endif> Ética y ciudadanía |
                                    <input type="checkbox" name="identidad" value="1"
                                        @if ($sumilla->identidad == 1) checked @endif> Identidad, interculturalidad e
                                    inclusividad |
                                    <input type="checkbox" name="inter_multi" value="1"
                                        @if ($sumilla->inter_multi == 1) checked @endif> Interdisciplinariedad y
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="borde">
                                ...
                                @else
                                    <textarea required name="perfil_docente" class="form-control summernote" cols="30" rows="5">{{ $sumilla->perfil_docente }}</textarea>
                                @endif
