            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-4" style="background-color: #F33154; color: white; border-radius: 10px">
                        <h2 align="center">CRÉDITOS (RESPONSABLES)</h2>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Autoridades de la Universidad, Facultad y Escuela Profesional
                                : </label>
                            <textarea name="autoridades" class="summernote" required>{{ $credito->autoridades }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Integrantes del Comité de Currículo
                                : </label>
                            <textarea name="integrantes" class="summernote" required>{{ $credito->contenido }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                ...
                <form action="{{ route('credito.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="tutores" class="summernote" required>{{ $credito->contenido }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Docente líder de currículo y calidad de la Facultad
                                : </label>
                            <textarea name="docente" class="summernote" required>{{ $credito->contenido }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Equipo de apoyo académico-administrativo
                                : </label>
                            <textarea name="apoyo" class="summernote" required>{{ $credito->contenido }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
