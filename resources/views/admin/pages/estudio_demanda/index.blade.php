...
@section('titulo')
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Estudio de la demanda social y el Mercado laboral de :
                        {{ $programa_estudio->nombre_programa }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <form action="{{ route('estudio_demanda.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="influencia_programa" class="summernote" required>{{ $estudio_demanda->influencia_programa }}</textarea>
                        </div>
                        <div class="col-sm-12">
                            <label>2.2. Resultados de la demanda laboral profesional: </label>
                            <textarea name="laboral_profesional" class="summernote" required>{{ $estudio_demanda->laboral_profesional }}</textarea>
                        </div>
                        <div class="col-sm-12">
                            <label>2.3. Resultados de la demanda formativa y oferta formativa similar existente
                                en el ámbito de influencia y su impacto en el ámbito laboral de los egresados del programa:
                            </label>
                            <textarea name="demanda_formativa" class="summernote" required>{{ $estudio_demanda->demanda_formativa }}</textarea>
                        </div>
                        <div class="col-sm-12">
                            ...
                            <textarea name="pertinencia_social" class="summernote" required>{{ $estudio_demanda->pertinencia_social }}</textarea>
                        </div>
                        <div class="col-sm-12">
                            <label>2.5. Características y justificación de las modalidades de estudio: </label>
                            <textarea name="modalidades_estudio" class="summernote" required>{{ $estudio_demanda->modalidades_estudio }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
