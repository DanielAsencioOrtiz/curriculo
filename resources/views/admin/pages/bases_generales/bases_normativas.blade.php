                ...
                <form action="{{ route('base_normativa.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="bn_contenido" class="summernote" required>{{ $base_general->bn_contenido }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="justify">
                                <p>Debe considerarse las normas nacionales (Ley Universitaria, Resoluciones Ministeriales,
                                    ...
                                    PROGRAMAS DE ESTUDIO DE PREGRADO DE LA UNIVERSIDAD NACIONAL DE TRUJILLO”, Directivas,
                                    Reglamentos, Normas profesionales nacionales e internacionales u
                                    otras afines) que motivan y respaldan la naturaleza, forma, orientación y funcionamiento
                                    del
                                    currículo.</p>
                            </div>
                        </div>
