...
@section('contenido')
    <div class="container">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <b>3.1.3 Bases Teórico - Conceptuales</b>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label>3.1.3.1 Concepción socioantropológica y cultural
                                    : </label>
                                <textarea name="concepcion_humano" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update2') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="concepcion_episte" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update3') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="concepcion_pedagogica" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update3') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="enfoque_competencias" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update3') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="modalidad_estudio" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update3') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="concepcion_curricular" class="summernote" required>
                    ...
                    <form action="{{ route('base_conceptuales.update3') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <textarea name="ejes_curriculares" class="summernote" required>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12" align="justify">
                                <p>Constituyen el soporte filosófico, científico y técnico que le da consistencia,
                                    orientación y
                                    sentido al currículo (en general, deben ser transcritos y/o adecuados de lo planteado en
                                    el
