                ...
                <form action="{{ route('eje_curricular.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="responsabilidad_social" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="investigacion_formativa" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="idi" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="sostenibilidad_ambiental" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="etica" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="identidad" class="summernote" required>
...
@endif
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="multidisciplinaria" class="summernote" required>
