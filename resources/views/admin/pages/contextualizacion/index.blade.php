...
@section('titulo')
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Contextualización del Programa Profesional: {{ $programa_estudio->nombre_programa }}
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('contextualizacion.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="sintesis" class="summernote" required>{{ $contextualizacion->sintesis }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                ...
                <form action="{{ route('contextualizacion.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>3.2.2 Determinación y justificación de la necesidad y pertinencia social y laboral del
                                Programa
                                Profesional en el ámbito de influencia regional, nacional e internacional: </label>
                            <textarea name="determinacion" class="summernote" required>{{ $contextualizacion->determinacion }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                ...
                <form action="{{ route('contextualizacion.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <textarea name="desarrollo" class="summernote" required>{{ $contextualizacion->desarrollo }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
